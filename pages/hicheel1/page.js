...
export default function Lab5() {
  ...
  return (
    <div>
      ...
      <div className="flex justify-center items-center bg-orange-100 h-screen w-full text-center px-4">
        <div>
      ...
      <div
        className="bg-gray-100 w-full py-16 px-4 flex flex-col md:flex-row items-center justify-center gap-10 h-screen"
        id="section1"
      >
        <img
      ...
      <div
        className="bg-orange-100 w-full py-16 px-4 flex flex-col-reverse md:flex-row items-center justify-center gap-10 h-screen"
        id="section2"
      >
      ...
      <div
        className="bg-white w-full py-16 px-4 flex flex-col items-center space-y-6 text-center"
        id="section4"
      >
