...
export default function Lab5() {
  ...
  return (
    <div className="flex flex-col bg-black h-screen justify-center items-center gap-5 bg-cover bg-center relative bg-gradient-to-r from-blue-950 to-slate-900">
      ...
      <div className="flex flex-col sm:flex-row sm:gap-10 z-10 p-8 border-4 border-gray-800 rounded-lg bg-gray-900 shadow-2xl">

        <button 
          className="mb-4 p-4 bg-white text-black rounded h-[100px] w-[300px] shadow-xl shadow-blue-900 hover:bg-blue-800 hover:text-white hover:scale-105 transition-all duration-300 hover:shadow-white"
