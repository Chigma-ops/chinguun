...
export default function Lab5() {
  ...
  return (
    <div className="flex flex-col bg-black h-screen justify-center items-center gap-5 bg-cover bg-center relative bg-gradient-to-r from-blue-950 to-slate-900">      
      <div className="flex flex-col border rounded-full p-10 z-10 border-white">
        <h1 className="text-white font-bold text-2xl sm:text-4xl md:text-5xl">Chinguun Toivgoo</h1>
      </div>
