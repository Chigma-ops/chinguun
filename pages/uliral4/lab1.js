  ...
  return (
    <div className="flex gap-x-6 p-4 bg-gray-400">
      ...
      <div className="flex gap-x-10 ">
        <div className="items-center flex justify-center h-[50px] w-[200px] bg-gray-700 rounded-xl text-white">Харилцагчид</div>
        <input
          type="text"
        ...
        <div className='bg-amber-600 items-center justify-center items-center h-[50px] w-[400px] rounded-xl flex text-white'>Харилцагчид бүртгэх</div>
        </div>
          ...
          <div className="p-4 flex flex-col gap-5">
            {data.map((item, index) => (
              ...
              >
                ...
                <img src={item.image} className="object-cover  h-[50px] w-[50px] ">
                </img>
